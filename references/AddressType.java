...
public class AddressType implements java.io.Serializable {
    ...
    public static final AddressType Delivery = new AddressType(_Delivery);
    public static final AddressType Office = new AddressType(_Office);
    public static final AddressType Work = new AddressType(_Work);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.nih.gov/NEDPersonV3", ">AddressType"));
    }
    /**
